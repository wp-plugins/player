...
<table width="90%">
<tr>   
<td style="font-size:14px; font-weight:bold;"><a href="http://webdorado.org/spider-video-player-wordpress-guide-step-6.html" target="_blank" style="color:blue; text-decoration:none;"><a href="http://webdorado.org/spider-video-player-wordpress-guide-step-6.html" target="_blank" style="color:blue; text-decoration:none;">User Manual</a></a><br />
This section allows you to create players, providing them with playlist(s) and a distinct visual theme. <a href="http://webdorado.org/spider-video-player-wordpress-guide-step-6.html" target="_blank" style="color:blue; text-decoration:none;">More...</a></td>   
...
var keyCode = event.keyCode ? event.keyCode : event.which ? event.which : event.charCode;
    ...
    <tr>   
<td width="100%" style="font-size:14px; font-weight:bold"><a href="http://webdorado.org/spider-video-player-wordpress-guide-step-6.html" target="_blank" style="color:blue; text-decoration:none;">User Manual</a><br />
This section allows you to create players, providing them with playlist(s) and a distinct visual theme. <a href="http://webdorado.org/spider-video-player-wordpress-guide-step-6.html" target="_blank" style="color:blue; text-decoration:none;">More...</a></td>   
  <td colspan="7" align="right" style="font-size:16px;">
  		<a href="http://webdorado.org/files/fromSVP.php" target="_blank" style="color:red; text-decoration:none;">
		<img src="<?php echo plugins_url("images/header.png",__FILE__) ?>" border="0" alt="http://webdorado.org/files/fromSVP.php" width="215"><br>
