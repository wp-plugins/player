...
<form action="admin.php?page=Spider_Video_Player_Playlists" method="post" name="adminForm" id="adminForm">
 <table width="90%">
      <tr>   
<td width="100%" style="font-size:14px; font-weight:bold"><a href="http://webdorado.org/spider-video-player-wordpress-guide-step-4.html" target="_blank" style="color:blue; text-decoration:none;">User Manual</a><br />
This section allows you to create plalist of videos. <a href="http://webdorado.org/spider-video-player-wordpress-guide-step-4.html" target="_blank" style="color:blue; text-decoration:none;">More...</a></td>   
